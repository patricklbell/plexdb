...
int main(int argc, char* argv[]) {
    ...
    auto arg_parser = argparse::make_parser("graphstore", "Graph and RDF database server (SPARQL)");
    argparse::add_positional(arg_parser, "db_path", "Path to the database file");
    argparse::add_option(arg_parser, "--port", "-p", "TCP port to listen on", "7200");
    ...
    String8 pid_file_path = "graphstore.pid";
    {
...

    {
        ...
        println("graphstore server not yet implemented");
    }
