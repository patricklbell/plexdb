...
int main(int argc, char* argv[]) {
    ...
    auto arg_parser = argparse::make_parser("sqlstore", "SQL database server with spatial extensions");
    argparse::add_positional(arg_parser, "db_path", "Path to the database file");
    argparse::add_option(arg_parser, "--port", "-p", "TCP port to listen on", "5432");
    ...
    String8 pid_file_path = "sqlstore.pid";
    {
...

    {
        ...
        println("sqlstore server not yet implemented");
    }
