...
namespace plexdb::btree {
    ...
    const Node*   read_node(TransactionInMemory& t, const NodeRef& ref)   { return reinterpret_cast<Node*>(ref); }
    Node*         update_node(TransactionInMemory& t, const NodeRef& ref) { return reinterpret_cast<Node*>(ref); }
    ...
    void          delete_node(TransactionInMemory& t, const NodeRef& ref) { os::deallocate(reinterpret_cast<void*>(ref)); }
}