...
namespace plexdb::os {
    ...
    static pid_t linux_handle_to_pid(Handle handle) {
        return memory_cast<S32>(&handle.u32[0]);
    }
    ...
    static U32 poll_mask_to_linux(PollEventMask events) {
        U32 out = 0;
        if ((U32(events) & U32(PollEventMask::Read)) != 0) {
            out |= EPOLLIN;
        }
        if ((U32(events) & U32(PollEventMask::Write)) != 0) {
            out |= EPOLLOUT;
        }
        if ((U32(events) & U32(PollEventMask::Error)) != 0) {
            out |= EPOLLERR;
        }
        if ((U32(events) & U32(PollEventMask::HangUp)) != 0) {
            out |= EPOLLHUP;
        }
        return out;
    }
    ...
    static PollEventMask linux_mask_to_poll(U32 events) {
        ...
        if ((events & EPOLLIN) != 0) {
            out = out | PollEventMask::Read;
        }
        if ((events & EPOLLOUT) != 0) {
            out = out | PollEventMask::Write;
        }
        if ((events & EPOLLERR) != 0) {
            out = out | PollEventMask::Error;
        }
        if ((events & EPOLLHUP) != 0) {
            out = out | PollEventMask::HangUp;
        }
        return out;
    }
